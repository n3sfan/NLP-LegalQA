"""
Non-Finetuned LLM Evaluation Script
...
Generation is done locally using Unsloth and the non-finetuned base model.

Usage:
    # 1. Generate answers
    uv run python scripts/eval_nonfinetuned_llm.py \
        --step-generate \
        ...
        --output eval_results/QA_Part2/eval_nonfinetuned_results.csv \
...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate Non-Finetuned LLM Answers")
    ...
    parser.add_argument("--output", default="eval_nonfinetuned_results.csv", help="Output CSV path")
    ...
    parser.add_argument("--model-name", type=str, default="unsloth/gemma-4-E4B-it", help="Name of the base model.")
